    ...
    return {
      ...
      user: {
        ...
        tenant: user.tenant ? {
          ...
          billingDay: user.tenant.billingDay,
          useCustomPrice: user.tenant.useCustomPrice,
          customPriceMonthly: user.tenant.customPriceMonthly,
          customPriceAnnual: user.tenant.customPriceAnnual,
