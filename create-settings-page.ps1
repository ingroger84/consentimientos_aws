            ...
            <div className="card">
              ...
              <div className="mb-4">
                {settings.footerLogoUrl ? (
                  <div className="flex items-center justify-center p-6 bg-gray-50 rounded-lg">
                    <img
                      src={`http://localhost:3000${settings.footerLogoUrl}`}
                      alt="Logo del footer"
                      className="max-h-32 object-contain"
                    />
                  </div>
            ...
            <div className="card">
              ...
              <div className="mb-4">
                {settings.watermarkLogoUrl ? (
                  <div className="flex items-center justify-center p-6 bg-gray-50 rounded-lg">
                    <img
                      src={`http://localhost:3000${settings.watermarkLogoUrl}`}
                      alt="Marca de agua"
...
$content | Out-File -FilePath "frontend/src/pages/SettingsPage.tsx" -Encoding UTF8 -NoNewline
